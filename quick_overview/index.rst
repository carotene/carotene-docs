...
To get started adding real-time with Carotene, we will follow a step-by-step tutorial that shows all Carontene's main features. In this practical example we will build a live scoreboard for sport events in 6 steps.
...
* How to republish messages into Redis (to gather analytics, for instance).
